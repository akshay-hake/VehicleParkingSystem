...
<body>
    <%
        ...
        try{  
                   ...
                   String q="select time_to_sec(timediff('"+dd+" "+dt+"','"+ad+" "+at+"'))/3600*10";
                    ResultSet rs=stmt.executeQuery(q);  
                    if(rs.next()) 
                    {
                        
                        amount=(int)rs.getDouble(1);
...
<div class="row">
  ...
  <div class="col-25">
    <div class="container">
      ...
      <hr>
      <p>Total <span class="price" style="color:black"><b>Rs. <% out.print(amount); %></b></span></p>
    </div>
  </div>
</div>
