    ...
    <body>
        ...
        <div style="padding-top: 100px" class="wrapper wrapper--w680">
            <div class="card card-4" style="background: salmon" >
                <div class="card-body">
                    <h2 class="title1" style="color: #721c24;padding-top:10px;margin-bottom: 50px ">Your Session is expired!</h2>
                        <div class="row row-space">
                            ...
                            <div style="padding-top: 50px;padding-left: 280px ">
                                    ...
                                    <button class="button"  type="submit" onclick="window.location='DriverLogin.jsp'">Retry</button>
