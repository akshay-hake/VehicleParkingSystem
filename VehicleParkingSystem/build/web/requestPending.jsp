    ...
    <body>
        ...
        <div style="padding-top: 100px" class="wrapper wrapper--w680">
            <div class="card card-4" style="background: #3b5998" >
                <div class="card-body">
                    <h2 class="title1" style="color:white;padding-top:10px;margin-bottom: 50px ">Request is pending !</h2>
                    ...
                    <div class="row row-space">
                             ...
                             <table style=" margin-left: 250px;">
                                        ...
                                        <form action="DriverLogin.jsp" method="get">
                                             ...
                                             <input class="button" id="send" style="margin-left: 15px;background-color: skyblue;width: 100%"  type="submit" value="OK" >
                                         </form>
                                         </td>
                                    </table>
                                </center>
