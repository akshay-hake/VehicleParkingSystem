      ...
      <li><a href="login.jsp"><span class="glyphicon glyphicon-log-in"></span> Logout</a></li>
        ...
        <% 
            ...
            try{  
                    ...
                    q="select slot_no from entry_detail where status<>'c' and arrival_time<='"+time+"' and departure_time>='"+time+"'";
                    ...
                    q="select sum(case when slot_no<=16 then 1 else 0 end) as reserved,sum(case when (slot_no>=17 and slot_no<=32) then 1 else 0 end) as 4w,sum(case when slot_no>=33 then 1 else 0 end) as 2w from entry_detail where status<>'c' and arrival_time<='"+time+"' and departure_time>='"+time+"'";
                    rs=stmt.executeQuery(q);  
                   if(rs.next()) 
                    {
                       rb=rs.getInt(1);
            ...
            <tr>
              <div class="row row-space">
                  <td>
                            <div class="col-2">
                                <div class="input-group"> 
                                    <label> Departure Date</label>  <input  class="input--style-4" type="date" name="dd" value="<%= ad %>">
             </div>
                            </div>
                  </td>
                  <td>
                            <div class="col-2">
                                <div class="input-group">
                                    <label>Departure time</label><input class="input--style-4" type="time" name="dt" value="<%=at %>">
            </div>
                            </div>
                  </td>
                        </div>
